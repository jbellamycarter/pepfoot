    ...
    def update_analysis(self):
        ...
        try:
            ...
            if treatment:
                ...
                max_mask = mean1 < mean2
                max_mean = mean1
                max_mean[max_mask] = mean2[max_mask]
                max_stdev = stdev1
                max_stdev[max_mask] = stdev2[max_mask]
                extent_mean[mask3] = diff_mean[mask3] / max_mean[mask3]
                extent_stdev = np.zeros_like(diff_stdev)
                extent_stdev[mask3] = extent_mean[mask3] * np.sqrt((diff_stdev[mask3]/diff_mean[mask3])**2 + (max_stdev[mask3]/max_mean[mask3])**2)
                mask4 = extent_mean > 0
                mean = -extent_mean
